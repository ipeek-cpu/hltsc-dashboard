...
export class PreviewManager {
   ...
   */
  loadUrl(url: string): { success: boolean; error?: string } {
    try {
      if (!url) {
   ...
   */
  openDevTools(): { success: boolean; error?: string } {
    if (!this.previewView) {
      return { success: false, error: 'No preview loaded' };
    }
   ...
   */
  closeDevTools(): { success: boolean; error?: string } {
    if (!this.previewView) {
      return { success: false, error: 'No preview loaded' };
    }
   ...
   */
  enableInspector(): { success: boolean; error?: string } {
    if (!this.previewView) {
      return { success: false, error: 'No preview loaded' };
    }
   ...
   */
  disableInspector(): { success: boolean; error?: string } {
    if (!this.previewView) {
      return { success: false, error: 'No preview loaded' };
    }
   ...
   */
  show(): { success: boolean; error?: string } {
    if (!this.previewView) {
      return { success: false, error: 'No preview loaded' };
    }
   ...
   */
  hide(): { success: boolean; error?: string } {
    if (!this.previewView) {
      return { success: false, error: 'No preview loaded' };
    }
